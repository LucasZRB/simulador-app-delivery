...
6. Salir
```
Dependiendo de si el usuario ya está registrado o no, la opción 2 (y siguientes) podrían estar **bloqueadas temporalmente** hasta que complete el registro inicial.
...
2. IceCreamShop   - 05/10/2025 - $12.00  ✅ Entregado
